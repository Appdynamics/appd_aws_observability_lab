...
echo "CloudWorkshop|INFO| - Start Undeploying Application to EKS Cluster"

cd /opt/appdynamics/workshopuser

kubectl delete -f post-mod-kube-app/


sleep 3
echo "CloudWorkshop|INFO|     - Waiting for Application to Undeploy ........................"
sleep 3
echo "CloudWorkshop|INFO|     - Waiting for Application to Undeploy ......................."
sleep 3
...
echo "CloudWorkshop|INFO|     - Waiting for Application to Undeploy ..."
sleep 3
echo "CloudWorkshop|INFO| - Finished Undeploying Application to EKS Cluster"
